...
public class loggedProfileView extends BorderPane {
    ...
    public loggedProfileView() {
        this(dataBaseManager.getConnectedAccount().getName(), "jean.dupont@email.com", "+33 6 12 34 56 78");
    }

    public loggedProfileView(String name, String email, String phone) {
